	...
	<div class="row">
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_usuarios.php">
			<div class="card border-left-primary shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center text-decoration-none">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1 " >Usuarios</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php  $sql = "SELECT count(*) from usuario";
			...
			<div class="card border-left-success shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-decoration-none">Clientes</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800 text-decoration-none"><?php  $sql = "SELECT count(*) from cliente";
                			$result = mysqli_query($conexion, $sql);
               				$filas = mysqli_fetch_array($result);
                			echo $filas[0]; ?></div>
						</div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="row no-gutters align-items-center">
								<div class="col-auto">
									<div class="h5 mb-0 mr-3 ml-3 font-weight-bold text-gray-800"><?php  $sql = "SELECT count(*) from producto";
                			$result = mysqli_query($conexion, $sql);
               				$filas = mysqli_fetch_array($result);
                			echo $filas[0]; ?></div>
								</div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php  $sql = "SELECT count(*) from factura";
                			$result = mysqli_query($conexion, $sql);
               				$filas = mysqli_fetch_array($result);
                			echo $filas[0]; ?></div>
						</div>
