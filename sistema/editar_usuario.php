...
if (!empty($_POST)) {
  $alert = "";
  if (empty($_POST['usuario']) || empty($_POST['correo']) || empty($_POST['rol'])) {
    ...
    $sql_update = mysqli_query($conexion, "UPDATE usuario SET  usuario = '$usuario', correo = '$correo' , rol = $rol WHERE idusuario = $idusuario");
