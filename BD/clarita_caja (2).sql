...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-10-2023 a las 17:36:33
...
INSERT INTO `cliente` (`idcliente`, `dni`, `nombre`, `usuario_id`) VALUES
(1, 1, 'Javier Vidarte', 1);
...
INSERT INTO `configuracion` (`id`, `dni`, `nombre`, `telefono`, `email`, `direccion`) VALUES
(1, 2580, 'VILLA CLARITA', 3115212431, 'villaclarita@gmail.com', 'RIVERA-HUILA');
...
(38, '2023-10-19 08:35:42', 5, 1, 45.00, 1),
(39, '2023-10-19 08:46:23', 1, 1, 45.00, 1),
(40, '2023-10-19 09:21:59', 1, 1, 16.00, 1);
...
INSERT INTO `usuario` (`idusuario`, `usuario`, `correo`, `clave`, `rol`) VALUES
(1, 'javier', 'javier@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 1);
...
--
ALTER TABLE `factura`
  MODIFY `nofactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
